...
now = datetime.now()
x = now.strftime("%H:%M")
y = 'enter discord webhook url'

def login_domain():
    driver = webdriver.Chrome()
    url = 'https://www.time4education.com/login/'
    driver.get(url)
    driver.find_element_by_xpath('/html/body/div[3]/div[2]/div/section/div/div[2]/div/div[1]/div[2]/form/div[1]/div[2]/input').click()
    driver.find_element_by_xpath('/html/body/div[3]/div[2]/div/section/div/div[2]/div/div[1]/div[2]/form/div[1]/div[2]/input').send_keys('username')
    driver.find_element_by_xpath('/html/body/div[3]/div[2]/div/section/div/div[2]/div/div[1]/div[2]/form/div[1]/div[5]/input').click()
    driver.find_element_by_xpath('/html/body/div[3]/div[2]/div/section/div/div[2]/div/div[1]/div[2]/form/div[1]/div[5]/input').send_keys('password')
